...
import { FlatApiKeyEntity } from 'src/engine/core-entity-cache/types/flat-api-key-entity.type';
import { FlatWorkspaceEntity } from 'src/engine/core-entity-cache/types/flat-workspace-entity.type';
...
export class McpCoreController {
  ...
  async handleMcpCore(
    @Body() body: JsonRpc,
    @AuthWorkspace() workspace: FlatWorkspaceEntity,
    @AuthApiKey() apiKey: FlatApiKeyEntity | undefined,
