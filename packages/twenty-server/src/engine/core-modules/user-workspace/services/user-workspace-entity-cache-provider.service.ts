...
import { fromUserWorkspaceEntityToFlat } from 'src/engine/core-entity-cache/utils/from-user-workspace-entity-to-flat.util';
import { UserWorkspaceEntity } from 'src/engine/core-modules/user-workspace/user-workspace.entity';

@Injectable()
@CoreEntityCache('userWorkspaceEntity')
export class UserWorkspaceEntityCacheProviderService extends CoreEntityCacheProvider<FlatUserWorkspaceEntity> {
  constructor(
  ...
  async computeForCache(
    entityId: string,
  ): Promise<FlatUserWorkspaceEntity | null> {
